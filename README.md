...
| additional\_packages | Space separated list of additional packages included for ansible setup that may need to be removed after running ansible | `string` | `""` | no |
